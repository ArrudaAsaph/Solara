...
| **RN17** | Qualquer alteração de dados sensíveis exige senha do ator administrativo. |
...
| 6 | | Exibe modal de confirmação informando a ação que será realizada e solicitando confirmação do ator. |
| 7 | Confirma a ação no modal. | |
| 8 | | Valida as Regras de Negócio **RN02** (se aplicável), **RN04**, **RN05**, **RN16** e **RN17**. |
