...
| **Requisito Atendido** | [RF24](../../requisitos/requisitos_funcionais.md#rf24) |
...
| **Requisito** | **Descrição** |
| :------------ | :------------ |
| [**RF24**](../../requisitos/requisitos_funcionais.md#rf24) | A empresa ou o gerente pode remover vendedores vinculados à própria empresa, respeitando as restrições de vínculo comercial/financeiro e mantendo rastreabilidade da ação. |
...
| **Código** | **Descrição** |
| :--------: | :------------ |
| [**RN23**](../../regras_de_negocio/regras_de_negocio.md#rn23) | Empresa e gerente podem remover vendedores apenas da mesma empresa à qual estão vinculados. |
| [**RN29**](../../regras_de_negocio/regras_de_negocio.md#rn29) | Não é permitido remover vendedor com contrato ativo ou comissionamento pendente; nesses casos a ação deve ser bloqueada. |
| [**RN09**](../../regras_de_negocio/regras_de_negocio.md#rn09) | Vendedores não possuem acesso direto ao sistema, sendo entidade de controle comercial e financeiro. |
...
| 8 | | Valida as Regras de Negócio [**RN23**](../../regras_de_negocio/regras_de_negocio.md#rn23) e [**RN29**](../../regras_de_negocio/regras_de_negocio.md#rn29). |
...
| 0.2 | | Valida a Regra de Negócio [**RN23**](../../regras_de_negocio/regras_de_negocio.md#rn23). |
...
| 0.5 | | Valida a Regra de Negócio [**RN29**](../../regras_de_negocio/regras_de_negocio.md#rn29). |
