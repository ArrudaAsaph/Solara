...
> **Descrição:** Caso de uso referente à atualização dos dados cadastrais de vendedores existentes na empresa. Vendedores não são usuários do sistema — não possuem credenciais de acesso ([RN09](../../regras_de_negocio/regras_de_negocio.md#rn09)).
...
| **Requisito Atendido** | [RF22](../../requisitos/requisitos_funcionais.md#rf22) |
...
| **Requisito** | **Descrição** |
| :------------ | :------------ |
| [**RF22**](../../requisitos/requisitos_funcionais.md#rf22) | A empresa ou o gerente pode atualizar os dados cadastrais e de comissionamento de vendedores vinculados à empresa, mantendo histórico das alterações. |
...
| **Código** | **Descrição** |
| :--------: | :------------ |
| [**RN23**](../../regras_de_negocio/regras_de_negocio.md#rn23) | Empresa e gerente podem atualizar vendedores apenas da mesma empresa à qual estão vinculados. |
...
| 8 | | Valida campos obrigatórios e consistência dos dados, conforme [**RN23**](../../regras_de_negocio/regras_de_negocio.md#rn23), [**RN24**](../../regras_de_negocio/regras_de_negocio.md#rn24) e [**RN09**](../../regras_de_negocio/regras_de_negocio.md#rn09). |
...
| 0.6 | | Valida a Regra de Negócio [**RN23**](../../regras_de_negocio/regras_de_negocio.md#rn23). |
