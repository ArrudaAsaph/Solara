...
| **Requisito** | **Descrição** |
| :------------ | :------------ |
| **RF09** | A empresa ou o gerente pode ativar ou desativar uma usina, impedindo seu uso em novos contratos sem excluir seus dados históricos. |
...
| **Código** | **Descrição** |
| :--------: | :------------ |
| **RN12** | Apenas empresa e gerentes podem ativar ou desativar usinas. |
| **RN30** | A ativação/desativação de usina só pode ocorrer para usinas vinculadas à mesma empresa do ator (empresa ou gerente). |
| **RN31** | Usinas desativadas não podem ser usadas em novos contratos, novos rateios ou novas vinculações operacionais até serem reativadas. |
...
| 7 | Confirma a ação. | |
| 8 | | Valida as Regras de Negócio **RN12**, **RN30** e **RN31**. |
...
| 0.2 | | Valida as Regras de Negócio **RN12** e **RN30**. |
