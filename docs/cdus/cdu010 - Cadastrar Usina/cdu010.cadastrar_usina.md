...
| **Requisito Atendido** | [RF07](../../requisitos/requisitos_funcionais.md#rf07) |
...
| **Requisito** | **Descrição** |
| :------------ | :------------ |
| [**RF07**](../../requisitos/requisitos_funcionais.md#rf07) | A empresa ou o gerente pode cadastrar usinas de geração de energia, informando dados técnicos, localização e vínculo com a empresa. |
...
| **Código** | **Descrição** |
| :--------: | :------------ |
| [**RN10**](../../regras_de_negocio/regras_de_negocio.md#rn10) | Uma usina só pode ser cadastrada se estiver vinculada à empresa do ator administrativo responsável pelo cadastro. |
| [**RN11**](../../regras_de_negocio/regras_de_negocio.md#rn11) | Não deve existir mais de uma usina com o mesmo identificador dentro da mesma empresa. |
| [**RN12**](../../regras_de_negocio/regras_de_negocio.md#rn12) | Apenas empresa e gerentes podem cadastrar usinas. |
| [**RN13**](../../regras_de_negocio/regras_de_negocio.md#rn13) | Todas as usinas devem ter um endereço cadastrado no sistema, associado à própria usina. |
| [**RN14**](../../regras_de_negocio/regras_de_negocio.md#rn14) | Uma usina não pode ter mais de um endereço cadastrado. |
| [**RN15**](../../regras_de_negocio/regras_de_negocio.md#rn15) | Um endereço pode ter mais de uma usina cadastrada. |
...
| 4 | | Valida as Regras de Negócio [**RN10**](../../regras_de_negocio/regras_de_negocio.md#rn10), [**RN11**](../../regras_de_negocio/regras_de_negocio.md#rn11), [**RN12**](../../regras_de_negocio/regras_de_negocio.md#rn12), [**RN13**](../../regras_de_negocio/regras_de_negocio.md#rn13), [**RN14**](../../regras_de_negocio/regras_de_negocio.md#rn14) e [**RN15**](../../regras_de_negocio/regras_de_negocio.md#rn15). |
...
| 0.2 | | Valida a Regra de Negócio [**RN11**](../../regras_de_negocio/regras_de_negocio.md#rn11). |
...
| 0.5 | | Valida a Regra de Negócio [**RN13**](../../regras_de_negocio/regras_de_negocio.md#rn13). |
...
| 0.8 | | Valida as Regras de Negócio [**RN10**](../../regras_de_negocio/regras_de_negocio.md#rn10) e [**RN12**](../../regras_de_negocio/regras_de_negocio.md#rn12). |
