...
| **RF17** | O analista pode listar apenas usuários vinculados às usinas às quais ele também está vinculado, sem acesso a usuários fora desse escopo. |
...
| **RN16** | Apenas empresa e gerente podem gerenciar usuários por hierarquia; o gerente só visualiza usuários de nível inferior. |
| **RN20** | Analistas podem listar apenas usuários vinculados às usinas às quais também estão vinculados, sem visualizar Empresa ou Gerente. |
...
| 0.2 | | Valida as Regras de Negócio **RN05**, **RN16** e **RN20**. |
