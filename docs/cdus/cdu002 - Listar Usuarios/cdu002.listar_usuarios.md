...
> **Descrição:** Caso de uso referente à listagem de usuários vinculados à empresa. Pode ser executado tanto pela **Empresa** quanto pelo **Gerente**, **Analistas (Energético e Finaceiro)**, com escopos diferentes conforme o ator.
...
Permite ao ator visualizar todos os usuários cadastrados e vinculados à empresa, podendo aplicar filtros por nome, tipo de usuário e status (ativo ou inativo).
...
- **Analistas (Energético e Financeiro):** visualiza apenas usuários de nível inferior ao seu, vinculados à mesma empresa.
...
| **Requisito** | **Descrição** |
| :------------ | :------------ |
| **RF05** | A empresa ou o gerente pode listar todos os usuários cadastrados vinculados à empresa, podendo usar filtros para a listagem. |
...
| **Código** | **Descrição** |
| :--------: | :------------ |
| **RN02** | Apenas empresas podem visualizar e gerenciar usuários do tipo gerente. O gerente não visualiza outros gerentes na listagem. |
| **RN05** | O gerente pode listar apenas usuários vinculados à mesma empresa à qual ele pertence. |
| **RN16** | O ator visualiza apenas usuários com papel hierarquicamente inferior ao seu. |
...
| 2 | | Recupera todos os usuários vinculados à empresa do ator, respeitando o escopo hierárquico (RN16). |
